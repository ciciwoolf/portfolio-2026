    ...
    <div className="border-t border-[var(--border)] bg-[var(--surface)] p-4">
      <div className="flex gap-2 items-center">
        ...
        <button
          ...
          className="px-6 py-2.5 bg-[var(--accent-button)] text-[var(--foreground-on-accent)] rounded-lg font-medium hover:bg-[var(--accent-button-hover)] focus:outline-none focus:ring-2 focus:ring-[var(--accent)] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shrink-0"
          style={{ height: '44px' }}
